...
static void MX_FDCAN1_Init(void)
{
  ...
  FDCAN1_TxHeader.Identifier = VCU_RX_BASE_ADDR;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OLED_CS_Pin|OLED_DC_Pin|OLED_Reset_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_9|GPIO_PIN_11|GPIO_PIN_13;
  ...
  /*Configure GPIO pins : PB10 OLED_CS_Pin OLED_DC_Pin OLED_Reset_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_10|OLED_CS_Pin|OLED_DC_Pin|OLED_Reset_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
