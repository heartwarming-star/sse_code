...
{
	HAL_GPIO_WritePin(OLED_CS_Port, OLED_CS_Pin, SET);
}
...
{
	HAL_GPIO_WritePin(OLED_DC_Port, OLED_DC_Pin, 0);
}
...
{
	HAL_GPIO_WritePin(OLED_DC_Port, OLED_DC_Pin, 1);
}
...
{
	HAL_GPIO_WritePin(OLED_RESET_Port, OLED_RESET_Pin, 0);
}
...
{
	HAL_GPIO_WritePin(OLED_RESET_Port, OLED_RESET_Pin, 1);
}
